...
import { CLOUDINARY_CLOUD_NAME, CONSTANTS } from './config.js';

// --- HARDCODED CREDENTIALS - REMOVE LATER ---
...
export async function saveSessionToAirtable(sessionData, sessionName) {
