...
exports.handler = async (event) => {
    try {
        ...
        // ... (this section contains the same find/create user logic as the old auth-verify function)
        ...
        // 6. Return a friendly message to the user
        return {
            statusCode: 200,
